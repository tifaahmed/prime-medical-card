...
class CardTemplateRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'front_empty' => ['nullable', 'image', 'mimes:jpeg,png,jpg,webp,avif', 'max:5120'],
            'front_example' => ['nullable', 'image', 'mimes:jpeg,png,jpg,webp,avif', 'max:5120'],
            'back' => ['nullable', 'image', 'mimes:jpeg,png,jpg,webp,avif', 'max:5120'],
