...
function ServiceCard({ service }: { service: Service }) {
    const paths = ICON_PATHS[service.icon_key] ?? ICON_PATHS.clinics;
...
export default function Services({ items = [] }: { items?: Service[] }) {
    ...
    const eyebrow = usePageContent('services_header', 'eyebrow', 'شبكة شاملة');
    const paragraph = usePageContent(
        'services_header',
        'paragraph',
        'من الكشف الطبي إلى الأدوية والتحاليل والأشعة — بطاقة واحدة تغطي كل احتياجات عائلتك الصحية',
    );
