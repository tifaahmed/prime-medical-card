    ...
    return (
        <>
            <a
                ...
                className="fixed bottom-24 left-4 z-[60] flex h-12 w-12 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg transition hover:scale-105 hover:bg-[#1fb358] sm:bottom-6 sm:left-6 sm:h-14 sm:w-14"
            >
            ...
            <button
                ...
                className="fixed bottom-24 right-4 z-[60] inline-flex items-center gap-2 rounded-full bg-[var(--amber-500)] px-4 py-3 text-xs font-bold text-[var(--teal-900)] shadow-lg transition hover:scale-105 hover:bg-[var(--amber-400)] sm:bottom-6 sm:right-6 sm:px-5 sm:py-3.5 sm:text-sm"
            >
                <svg
                    viewBox="0 0 24 24"
                    fill="none"
