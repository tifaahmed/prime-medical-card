        ...
        >
            ...
            >
                <a
                    ...
                    className="flex w-full items-center gap-1.5 rounded-md bg-[#25D366] px-2.5 py-1.5 text-start whitespace-nowrap shadow-md transition-all duration-300 hover:scale-105 hover:shadow-xl"
                >
                    <IconWhatsapp />
                    <span className="text-xs font-medium text-[#004d40]">
                ...
                <a
                    href="/contact"
                    className="flex w-full items-center gap-1.5 rounded-md bg-[#FF6B6B] px-2.5 py-1.5 text-start whitespace-nowrap shadow-md transition-all duration-300 hover:scale-105 hover:shadow-xl"
                >
                    <IconEnvelope />
                    <span className="text-xs font-medium text-[#4a0000]">
                        تواصل معنا
                    </span>
                </a>
                ...
                <a
                    ...
                    className="flex w-full items-center gap-1.5 rounded-md bg-[#FFA500] px-2.5 py-1.5 text-start whitespace-nowrap shadow-md transition-all duration-300 hover:scale-105 hover:shadow-xl"
                >
                    <IconPhone />
                    <span className="text-xs font-medium text-[#4a2800]">
                        اتصل بنا
                    </span>
                </a>
            </div>
